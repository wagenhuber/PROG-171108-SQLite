...
//        connection.close();
        ...
        System.out.println("####Personen in Datanbank####");
        connection = DriverManager.getConnection("jdbc:sqlite:d:\\wagenhuberg\\sqlite\\personen.sqlite");
        ...
        System.out.println("####Personenobjekte im Speicher####");
        PersonService personService = new PersonService();
        Person neuePerson = personService.readPerson(1);
        System.out.println(neuePerson.toString());
